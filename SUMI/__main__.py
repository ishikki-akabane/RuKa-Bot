...
from SUMI import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER, OWNER_NAME, UPDATE_CHANNEL,
                          OWNER_ID, PORT, SUPPORT_CHAT, COTB, TOKEN, URL, WEBHOOK, OWNER_USERNAME,
...
SUMI_DISPACHER_PIC = "https://telegra.ph/file/d03f381c8178a8fd2dc27.jpg"

GROUPSTART_VID = ""

DONATE_STRING = """ Adding Me To Your Groups Is Donation For Me Though I Would Appreciate If You Join My Creator's Network @KazumaClanXD"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
                GROUPSTART_VID,
                caption="Hola, I Am Alive and working perfectly fine",
