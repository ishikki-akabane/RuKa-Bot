...
#Repo recreated by Ishikki Akabane (@ishikki_akabane)
...
ɪ'ᴍ ᴀɴ ᴀɴɪᴍᴇ ᴛʜᴇᴍᴇᴅ ᴀᴅᴠᴀɴᴄᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ. ɪ ʜᴀᴠᴇ ʟᴏᴛs ᴏғ ʜᴀɴᴅʏ ғᴇᴀᴛᴜʀᴇs.
...
SUMI1_IMG = "https://te.legra.ph/file/7bd18e2d1345f6705f41b.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Sumi is hosted on its own server and require donations as of now but \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Sumi.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
          ...
          update.effective_message.reply_video(
            random.choice(SUMI_IMG), caption= "I'm awake already!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
