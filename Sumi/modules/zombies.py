...
from Sumi import telethn as SumiTelethonClient
from Sumi.modules.sql.clear_cmd_sql import get_clearcmd
from Sumi.modules.helper_funcs.telethn.chatstatus import user_is_admin
from Sumi.modules.helper_funcs.misc import delete


@SumiTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
