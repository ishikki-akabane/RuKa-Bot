...
import RUKA.modules.sql.global_bans_sql as sql
from RUKA.modules.sql.users_sql import get_user_com_chats
from RUKA import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from RUKA.modules.helper_funcs.misc import send_to_list
