...
from RUKA import dispatcher, updater
import RUKA.modules.sql.nsfw_sql as sql
...
LIST_NSFW_CHATS_HANDLER = CommandHandler("nsfwchats", list_nsfw_chats, filters=CustomFilters.dev_filter)
